--infinite yield but i made it for ro archive
-- line 4343 tags
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'skibidhub', DESC = 'opens skibidi hub'}
...
addcmd('skibidihub', {'', ''}, function(args, speaker)
